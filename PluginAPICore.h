...
/**
 * Api state system allows functions to ensure that they are
 * allowed to operate at the current phase of execution LSD
 * is operating at.
 */
enum API_STATE {
    STATE_PINIT,
...
/**
 * Used by CORE ONLY. I repeat: ONLY INCLUDE THIS HEADER
 * IN LSD CORE
 */
int lsdapi_setState(enum API_STATE state);

int lsdapi_initPlugin();
