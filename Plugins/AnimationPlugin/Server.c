...
void adBufferOut(struct LSD_SceneNodeOutput const * output){
    struct AttackDecayState* castData = (struct AttackDecayState*)output->parentNode->data;
    double* srcVal;
...
void* adPointerOut(struct LSD_SceneNodeOutput const * output){
    struct AttackDecayState* castData = (struct AttackDecayState*)output->parentNode->data;
...
// Plugin Events
int animationPluginInit(struct LSD_ScenePlugin const * plugin){
...
void animationPluginClean(struct LSD_ScenePlugin const * plugin){}

void animationPluginRPC(cJSON* in, cJSON* out){
