...
void timeNodeClean(struct LSD_SceneNodeInst const * inst, void* instData){

}

void timeNodeDelete(struct LSD_SceneNodeInst const * inst, void* instData){

}

void timeRPCHandler(cJSON* in, cJSON* out){
...
void timePluginClean(struct LSD_ScenePlugin const * plugin){
